...
if __name__ == "__main__":
    ...
    print(posterior_3)
    Task_1.plot_bar(posterior_3, "(sigma = 30,{(2.2, -0.2)}) Hypothesis", "Posterior probability")
    ...
    print(posterior_4)
    Task_1.plot_bar(posterior_4, "(sigma = 30,{(2.2, -0.2), (0.5, 0.5)}) Hypothesis", "Posterior probability")
    ...
    print(posterior_5)
    Task_1.plot_bar(posterior_5, "(sigma = 30,{(2.2, -0.2), (0.5, 0.5), (1.5, 1)}) Hypothesis", "Posterior probability")
